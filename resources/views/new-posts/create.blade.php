    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg max-w-2xl">
                <form method="POST" action="{{ route('new-posts.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('new-posts.index') }}" class="text-sm text-gray-600 underline hover:text-gray-900">{{ __('Cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
